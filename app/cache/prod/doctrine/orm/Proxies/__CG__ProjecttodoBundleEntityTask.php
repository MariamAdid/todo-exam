...
namespace Proxies\__CG__\Project\todoBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Task extends \Project\todoBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Project\\todoBundle\\Entity\\Task' . "\0" . 'id', '' . "\0" . 'Project\\todoBundle\\Entity\\Task' . "\0" . 'titre', '' . "\0" . 'Project\\todoBundle\\Entity\\Task' . "\0" . 'description', '' . "\0" . 'Project\\todoBundle\\Entity\\Task' . "\0" . 'dateExpiration');
        }
